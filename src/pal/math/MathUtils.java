...
/*
 * MDW comment: there is overlap here with pal.misc.Utils.
 */
...
public class MathUtils {
	 ...
	 * @return the total of a the values in a range of an array
	 */
	public static final int getTotal(int[] array, int start, int end) {
		int total = 0;
		for(int i = start ; i < end ; i++) {
			total+=array[i];
		}
	...
	public static final int getTotal(int[] array) {
	 ...
	 */
	public static final int getMinimum(int[] array, int start, int end) {
	 ...
	 */
	public static final int getMinimum(int[] array) {
	 ...
	 */
	public static final int getMaximum(int[] array) {
	 ...
	 */
	public static final int getMaximum(int[] array, int start, int end) {
