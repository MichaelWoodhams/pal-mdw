 ...
 * 
 * TODO!
 * I've introduced the Jama library for use in the EigenSystem class, so now we should refactor to use that Matrix class instead.
 * --- MDW (Michael Woodhams.)
 */
public final class Matrix {
	...
	// MDW's added comment:
	// Arguments are the wrong way around! (I won't change it, for fear of breaking something elsewhere.)
	// a = new Matrix(n,m) then means we access bottom right corner as  a.getValue(m-1,n-1).
