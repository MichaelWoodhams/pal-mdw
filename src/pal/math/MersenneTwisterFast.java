 ...
 * <p> 
 * - added optional tests so that you can forbid using unseeded random numbers.
 */
public class MersenneTwisterFast implements Serializable
		{
		private static boolean ALLOW_UNSEEDED = true; 
		private boolean seeded; // Has this instance been seeded? (else it seeded off system clock)
	...
	public static final void setStaticSeed(long seed) {
		synchronized(DEFAULT_INSTANCE) {
			DEFAULT_INSTANCE.setSeed(seed);
		}
	}
	/** Access a default instance of this class, access is synchronized */
