...
public class GeneralPoissonRateMatrix implements NeoRateMatrix {
	...
	// MDW: Added methods to NeoRateMatrix. This is just lazy programming, however.
	public void setUpperBounds(double[] bounds)             { throw new RuntimeException("Assertion error : not expected"); }
	public void setUpperBounds(double bound)                { throw new RuntimeException("Assertion error : not expected"); }
	...
	public void printObject(PrintStream out, String prefixString) { this.printObject(out,prefixString,null);}
	public void printObject(PrintStream out, String prefixString, double[] parameters) {
		out.println(prefixString+"Object: GeneralPoissonRateMatrix. printObject method not implemented.");
	}
}
