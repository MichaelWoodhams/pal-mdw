...
public class GeneralRateDistributionSubstitutionModel extends Parameterized.ParameterizedUser implements RateMatrixSubstitutionModel {
	...
	public GeneralRateDistributionSubstitutionModel(NeoRateMatrix base, RateDistribution rateDistribution, DataType dt, double[] frequencies) {
		this(base, rateDistribution, dt, frequencies, false);
	}
	public GeneralRateDistributionSubstitutionModel(NeoRateMatrix base, RateDistribution rateDistribution, DataType dt, double[] frequencies, boolean fixedFrequencies) {
