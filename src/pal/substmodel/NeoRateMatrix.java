 ...
 *  <li> 5 Mar 2009 - added printObject
 *  <li> 16 May 2011 - added isIndependentOfEqbmFreq()
 * </ul>
 */
public interface NeoRateMatrix extends  Serializable{
	...
	/**
	 * If true, then the model parameters can be divided into equilibrium base frequencies and
	 * others. The other parameters are used to generate a relative rate matrix, which then gets
	 * modified by equilibrium base frequencies to generate the Q matrix. 
	 * If false, there is no simple relationship between model parameters and base frequencies.
	 * createRelativeRates method returns a Q matrix. Equilibrium base frequencies cannot be 
	 * directly set.
	 */
	public boolean isIndependentOfEqbmFreq();
