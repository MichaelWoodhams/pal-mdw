...
// -=-=-=-==--=-=-=-=-==--==--=-=-=-=-==--==--==-=-==--=-=-=-=-=-==================-=-=-=-=-==--=-==--==-=--=-=-=-=-=-=
	...
	public static class SimpleNeutralSelection extends PalObjectListener.EventGenerator implements SubstitutionModel {
		...
		public void getTransitionProbabilities(double branchLength, ModelEdgeParameters edgeParameters, int category, double[][] tableStore) {
			getTransitionProbabilities(branchLength,category,tableStore);
		}
		public void getTransitionProbabilitiesTranspose(double branchLength, ModelEdgeParameters edgeParameters, int category, double[][] tableStore) {
			getTransitionProbabilitiesTranspose(branchLength,category,tableStore);
		}
		*/
		public void getTransitionProbabilities( double branchLength, ModelEdgeParameters edgeParams, double[][][] tableStore ) {
			check();
