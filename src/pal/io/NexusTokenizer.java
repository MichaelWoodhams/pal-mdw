...
public final class NexusTokenizer {
	...
	/**
	 * Reads tokens, skipping over 'newline's.
	 * @return
	 * @throws IOException
	 * @throws NexusParseException
	 */
	public String readNonNewlineToken() throws IOException, NexusParseException {
		String token;
		do { token = readToken(); } while (getLastTokenType()==NexusTokenizer.NEWLINE_TOKEN);
		return token;
	}
	/**
