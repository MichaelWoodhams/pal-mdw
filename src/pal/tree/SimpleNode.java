...
public class SimpleNode implements AttributeNode {
	...
	public String toString() {
		...
		NodeUtils.printNH(new PrintWriter(sw), this, true, false, false, false, false, 0, false);
		return sw.toString();
	}
	
	public String toStringWithEdgeParameters() {
		StringWriter sw = new StringWriter();
		NodeUtils.printNH(new PrintWriter(sw), this, true, false, true,  false, false, 0, false);
		return sw.toString();
	}
}
