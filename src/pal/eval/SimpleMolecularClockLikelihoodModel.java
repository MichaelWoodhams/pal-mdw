...
public class SimpleMolecularClockLikelihoodModel implements MolecularClockLikelihoodModel {
    ...
    public ConditionalProbabilityStore calculatePostExtendedFlatConditionals( double topBaseHeight, double bottomBaseHeight, PatternInfo centerPattern,
      ...
      ConditionalProbabilityStore rightConditionalProbabilityProbabilties 	) {
		  return base_.calculatePostExtendedFlat(heightConverter_.getExpectedSubstitutionDistance(bottomBaseHeight,topBaseHeight), null, model_,centerPattern,leftConditionalProbabilityProbabilties,rightConditionalProbabilityProbabilties,true);
        ...
        final ConditionalProbabilityStore rightConditionalProbabilityProbabilties
		  ...
		  return base_.calculateExtended(heightConverter_.getExpectedSubstitutionDistance(bottomBaseHeight,topBaseHeight), false, null, model_,centerPattern,leftConditionalProbabilityProbabilties,rightConditionalProbabilityProbabilties,true);
		}
      ...
      ConditionalProbabilityStore otherConditionalProbabilityProbabilties 	) {
		  return base_.calculateExtended(heightConverter_.getExpectedSubstitutionDistance(bottomBaseHeight,topBaseHeight), false, null, model_,centerPattern,ascenedentConditionalProbabilityProbabilties,otherConditionalProbabilityProbabilties,true);
		}
...
// -=-=--==-=-=-=---=-==-=--==-=-=-=-
	...
	private static final class ExternalImpl implements External {
		...
		public void calculateSingleExtendedConditionals(double topBaseHeight, double bottomBaseHeight,
	   	...
	   	base_.calculateSingleExtendedIndirect(heightConverter_.getExpectedSubstitutionDistance(bottomBaseHeight,topBaseHeight), null, model_,numberOfPatterns,baseConditionalProbabilities,resultConditionalProbabilities);
		}
		...
		public void calculateSingleDescendentExtendedConditionals(
		  double topBaseHeight, double bottomBaseHeight,
			...
			base_.calculateSingleExtendedDirect(heightConverter_.getExpectedSubstitutionDistance(bottomBaseHeight,topBaseHeight), null, model_,centerPattern.getNumberOfPatterns(),descendentConditionalProbabilities);
		}
		/**
     */
    public void calculateSingleAscendentExtendedConditionalsDirect(
		  ...
		  ConditionalProbabilityStore ascendentConditionalProbabilityProbabilties
			...
			base_.calculateSingleExtendedDirect(heightConverter_.getExpectedSubstitutionDistance(bottomBaseHeight,topBaseHeight), null, model_,centerPattern.getNumberOfPatterns(),ascendentConditionalProbabilityProbabilties);
		}
		/**
     */
    public void calculateSingleAscendentExtendedConditionalsIndirect(
		  ...
		  ConditionalProbabilityStore resultConditionalProbabilityProbabilties
			...
			base_.calculateSingleExtendedIndirect(heightConverter_.getExpectedSubstitutionDistance(bottomBaseHeight,topBaseHeight), null, model_,centerPattern.getNumberOfPatterns(),baseAscendentConditionalProbabilityProbabilties,resultConditionalProbabilityProbabilties);
		}
		...
		public void calculateExtendedConditionals( double topBaseHeight, double bottomBaseHeight,
		  ...
		  base_.calculateExtended(heightConverter_.getExpectedSubstitutionDistance(bottomBaseHeight,topBaseHeight), false, null, model_,centerPattern,leftConditionalProbabilities,rightConditionalProbabilities,resultStore);
		}
		/**
...
// -=-=--==-=-=-=---=-==-=--==-=-=-=-
	...
	private static final class LeafImpl implements Leaf {
		...
		public ConditionalProbabilityStore calculateExtendedConditionals(double topBaseHeight, double bottomBaseHeight) {
			// MDW: added extra argument
			return base_.getExtendedConditionalProbabilities(heightConverter_.getExpectedSubstitutionDistance(bottomBaseHeight,topBaseHeight),null,model_,true);
		}
