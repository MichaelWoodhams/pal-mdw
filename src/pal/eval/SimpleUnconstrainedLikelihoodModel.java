...
public class SimpleUnconstrainedLikelihoodModel implements UnconstrainedLikelihoodModel {
  ...
  private static final class ExternalImpl implements External {
    ...
    public void calculateExtended( double distance,
			...
			base_.calculateExtended(distance, forwardsInTime, edgeParams, model_,centerPattern,leftConditionalProbabilities,rightConditionalProbabilities,resultStore);
		}
    ...
    {
			base_.calculateSingleExtendedDirect(distance,edgeParams,model_,numberOfPatterns,conditionalProbabilities);
		}
    ...
    {
			base_.calculateSingleExtendedIndirect(distance,edgeParams,model_,numberOfPatterns,baseConditionalProbabilities,resultConditionalProbabilities);
		}
    ...
    {
		  return base_.calculateLogLikelihood(distance,edgeParams,model_,centerPattern,leftFlatConditionalProbabilities,rightFlatConditionalProbabilities,tempStore);
    }

    public double calculateLogLikelihood( PatternInfo centerPattern,
                                       ConditionalProbabilityStore leftConditionalProbabilities,
                                       ConditionalProbabilityStore rightConditionalProbabilities ) {
			return base_.calculateLogLikelihood(model_,centerPattern,leftConditionalProbabilities,rightConditionalProbabilities,null);
		}
    ...
    public SiteDetails calculateSiteDetailsUnrooted( 
	    ...
	    ConditionalProbabilityStore tempStore)
    {
    	return base_.calculateSiteDetailsUnrooted(distance,edgeParams,model_,centerPattern,leftConditionalProbabilitiesStore,rightConditionalProbabilitiesStore,tempStore);
    }
...
// =================================================================================================
  ...
  public static final class InternalImpl implements Internal {
    ...
    {
    	return base_.calculateExtended(distance,false,edgeParams,model_,centerPattern,leftConditionalProbabilities,rightConditionalProbabilities,true);
    }
...
// =================================================================================================
	public static final class LeafImpl implements Leaf {
		...
		public ConditionalProbabilityStore getExtendedConditionalProbabilities( double distance,ModelEdgeParameters edgeParams) {
			return base_.getExtendedConditionalProbabilities(distance,edgeParams,model_,true);
		}
		public Leaf getCopy() {
